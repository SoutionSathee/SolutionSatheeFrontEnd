                    ...
                    <div class="relative" data-te-dropdown-ref>
                      <div class="relative" data-te-dropdown-position="dropend">
                        <Menu as="div" className="relative  text-left">
                          <div>
                            <Menu.Button className="inline-flex w-full justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-semibold text-white shadow-sm ring-1 ring-inset  bg-[#172236]">
                              Choose Loan Type
                              <ChevronDownIcon
